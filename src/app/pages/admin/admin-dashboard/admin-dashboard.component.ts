...
export class AdminDashboardComponent implements OnInit {
  ...
  async loadDashboard(): Promise<void> {
    const res = await this.dashboardService.loadDashboard();

    const data =
      res?.resultData ??
      {};

    this.summary.total_users = data.total_users || 0;
    this.summary.admin_users = data.admin_users || 0;
    this.summary.normal_users = data.normal_users || 0;
